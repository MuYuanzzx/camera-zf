...
#define uart1_user_isr CPUIntIdx6_IRQn
#define uart2_user_isr CPUIntIdx3_IRQn
#define uart3_user_isr CPUIntIdx1_IRQn
#define uart4_user_isr CPUIntIdx5_IRQn
#define uart5_user_isr CPUIntIdx4_IRQn

void uart_init_intidx(uart_index_enum uart_n, uint32 baud, uart_tx_pin_enum tx_pin, uart_rx_pin_enum rx_pin,IRQn_Type int_idx,uint32_t PreemptPriority, uint32_t SubPriority);
#endif
