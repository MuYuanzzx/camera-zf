...
void interrupt_set_priority_EncodePriority(IRQn_Type irqn, uint32_t PreemptPriority, uint32_t SubPriority);
void interrupt_init_EncodePriority (cy_stc_sysint_irq_t *isr_config, cy_systemIntr_Handler user_isr_func,uint32_t PreemptPriority, uint32_t SubPriority);
#endif
