...
#define CONFIG_VL53L8CX_DISABLE_AMBIENT_PER_SPAD 1
#define CONFIG_VL53L8CX_DISABLE_NB_SPADS_ENABLED 1
#define CONFIG_VL53L8CX_DISABLE_NB_TARGET_DETECTED 1
#define CONFIG_VL53L8CX_DISABLE_SIGNAL_PER_SPAD 1
#define CONFIG_VL53L8CX_DISABLE_RANGE_SIGMA_MM 1
#define CONFIG_VL53L8CX_DISABLE_DISTANCE_MM 0
#define CONFIG_VL53L8CX_DISABLE_REFLECTANCE_PERCENT 1
#define CONFIG_VL53L8CX_DISABLE_TARGET_STATUS 0
#define CONFIG_VL53L8CX_DISABLE_MOTION_INDICATOR 1

#if CONFIG_VL53L8CX_DISABLE_AMBIENT_PER_SPAD
  #define VL53L8CX_DISABLE_AMBIENT_PER_SPAD
#endif

#if CONFIG_VL53L8CX_DISABLE_NB_SPADS_ENABLED
  #define VL53L8CX_DISABLE_NB_SPADS_ENABLED
#endif

#if CONFIG_VL53L8CX_DISABLE_NB_TARGET_DETECTED
  #define VL53L8CX_DISABLE_NB_TARGET_DETECTED
#endif

#if CONFIG_VL53L8CX_DISABLE_SIGNAL_PER_SPAD
  #define VL53L8CX_DISABLE_SIGNAL_PER_SPAD
#endif

#if CONFIG_VL53L8CX_DISABLE_RANGE_SIGMA_MM
  #define VL53L8CX_DISABLE_RANGE_SIGMA_MM
#endif

#if CONFIG_VL53L8CX_DISABLE_DISTANCE_MM
  #define VL53L8CX_DISABLE_DISTANCE_MM
#endif

#if CONFIG_VL53L8CX_DISABLE_REFLECTANCE_PERCENT
  #define VL53L8CX_DISABLE_REFLECTANCE_PERCENT
#endif

#if CONFIG_VL53L8CX_DISABLE_TARGET_STATUS
  #define VL53L8CX_DISABLE_TARGET_STATUS
#endif

#if CONFIG_VL53L8CX_DISABLE_MOTION_INDICATOR
