...
#define BIT_SET   1
#define BIT_RESET 0
#define GPIO_OLED   GPIOD
#define LCD_CSout(data)		  data ? GPIO_SetBits(GPIO_OLED,GPIO_Pin_0) :GPIO_ResetBits(GPIO_OLED,GPIO_Pin_0)//CS
#define LCD_DCout(data)		  data ? GPIO_SetBits(GPIO_OLED,GPIO_Pin_1) :GPIO_ResetBits(GPIO_OLED,GPIO_Pin_1)//DC
#define LCD_RSTout(data)		data ? GPIO_SetBits(GPIO_OLED,GPIO_Pin_3) :GPIO_ResetBits(GPIO_OLED,GPIO_Pin_3)//RST
#define LCD_SDAout(data)		data ? GPIO_SetBits(GPIO_OLED,GPIO_Pin_4) :GPIO_ResetBits(GPIO_OLED,GPIO_Pin_4)//SDA
#define LCD_SCLout(data)		data ? GPIO_SetBits(GPIO_OLED,GPIO_Pin_5) :GPIO_ResetBits(GPIO_OLED,GPIO_Pin_5)//SCL
